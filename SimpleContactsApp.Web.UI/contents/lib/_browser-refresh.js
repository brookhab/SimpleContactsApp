setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44374/SimpleContactsApp.Web.UI/,ws://localhost:60127/SimpleContactsApp.Web.UI/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
